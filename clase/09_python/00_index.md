...
Completa el curso y sube la certificacion a tu directorio de certificaciones, crea un nuevo file llamado python_apis_06.md y adjunta el link a la certificacion. No olvides referenciarlo en canvas (el pull request).

:::

:::homework{id="9.8" title="Introduccion a FastAPI" due="2026-03-10" points="20"}
